...
--
-- Host: localhost:3306
-- Generation Time: Sep 12, 2017 at 02:04 AM
...
--
-- Database: `fee_session`
--
CREATE DATABASE IF NOT EXISTS `fee_session` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `fee_session`;
