...
{	
	...
	{
		$class=$arr_cls['sno'];
		$sel_stdnt=mysql_query("select stdnt_reg.schlr_no,fname,lname,f_name,m_name,sec,rg_dt,dob from stdnt_reg where stdnt_reg.cls='$class' && stdnt_reg.rte='Yes' && `continoue_discontinoue_status`='0'");
