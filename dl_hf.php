	...
	<div class="page-content">
		<div class="row">
            ...
            <div style="padding-left:40%; margin-top:2%;">
              <button class="btn btn-info" name="view" type="button" onClick="due_hstl_fees()">View</button>
            ...
            <tr>
            <td><h3 align="center">Dues List (Hostel Fees)</h3></td>
            </tr>
            <tr>
            ...
            <div id="hstl_fee" style="float:left; width:100%;">
            </div>
            </form>
...
function pop_print()
{
	...
	w.document.write(jQuery('#hstl_fee').html());
	w.document.close();
	w.print();
} 
</script>
