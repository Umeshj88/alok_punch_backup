...
{
	extract($_POST);
	 $sec=mysql_query("select * from `category` where `ctg`='".$category."'");
	 $row=mysql_num_rows($sec);
	 if(empty($row))
	 {
		mysql_query("insert into `category` set `ctg`='".$category."'");
	 }
}
if(isset($_POST['edit']))
{
	 ...
	 if(empty($row))
	 {
		mysql_query("update `category` set `ctg`='".$category."' where `ctg`='".$r1."'");
	 }
}
if(isset($_POST['delete']))
{
	extract($_POST); 
	$sql="delete from `category` where `ctg`='".$r1."'";
	$r=mysql_query($sql);
		...
		<div class="page-content">
       	<div class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i>Category Setup
							</div>
							...
							<div class="tab-content">
								<div class="tab-pane fade active in" id="tab_1_1">
                                    ...
                                    <td><label>Category</label></td>
                                                <td><input class="form-control input-medium" name="category" placeholder="Category" type="text" ></td>
                                    </tr>
                                    <tr>
                                    <td></td>
                                    <td>
								...
								<div class="tab-pane fade" id="tab_1_2">
                                    ...
                                    <tr> 
                                    <td><label>Category</label></td>
                                                <td><input class="form-control input-medium" name="category" placeholder="Category" id="se" type="text"></td>
                                    </tr>
                                    <tr>
                                    <td></td>
                                    <td>
                                        ...
                                        { ?>
                                           ...
                                           <tr>
                                           <td>
                                           <input id="r<?php echo $row['sno']; ?>" type="radio" value="<?php echo $row['ctg']; ?>" name="r1" onClick="getstrm1(this.id)"></input>
                                           </td>
                                           <td>
                                           <?php echo $row['ctg'];?>
                                           </td>
								...
								<div class="tab-pane fade" id="tab_1_3">
									<form method="POST" name="3">
                                        ...
                                        { ?>
                                           ...
                                           <tr>
                                           <td>
                                           <input id="r<?php echo $row['sno']; ?>" type="radio" value="<?php echo $row['ctg']; ?>" name="r1"></input>
                                           </td>
                                           <td>
                                           <?php echo $row['ctg'];?>
                                           </td>
