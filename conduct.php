...
{
	ob_start();
	header("location: conduct_add.php");
	ob_flush();
}
if(isset($_POST['edit']))
{
	ob_start();
	header("location: conduct_edit.php?selected=$nm");
	ob_flush();
}
if(isset($_POST['delete']))
{
	mysql_query("delete from conduct_detail where name='$nm'");
	ob_start();
...
function valueselect()
{
    ...
    window.location.href = "conduct.php?selected=" + p;
}
</script>
</head>
