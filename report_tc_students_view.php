...
{	
	...
	{
		$class=$arr_cls['sno'];
		$sel_stdnt=mysql_query("select stdnt_reg.schlr_no,fname,lname,f_name,m_name,sec,rg_dt,dob from stdnt_reg,tc_serial_no where stdnt_reg.cls='$class' && stdnt_reg.id=tc_serial_no.schlr_no_id && tc_serial_no.status='1'");
