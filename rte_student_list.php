...
if(isset($_POST['print']))
{
	...
	$cls=$_POST['cls'];
	echo "<script>
	window.open('rte_student_list_view.php?cls=$cls&r1=$r1','_blank');
	</script>";
	echo "<meta http-equiv='Refresh' content='0 ;URL=rte_student_list.php'>";
	exit;
}
?>
<!DOCTYPE html>
...
<head>
<title>Rte Student | <?php title();?></title>
<?php
logo();
css();
ajax();
